...
const CaseCard = ({ title, description, size = 'small' }) => {
  ...
  return (
    <div className={`bg-[#141414] rounded-2xl p-8 ${cardSize} hover:bg-[#1B1B1B] transition-colors duration-300 group`}>
      <div className="flex justify-between items-start h-full">
        ...
        {/* Кнопка */}
        <button className="w-12 h-12 border border-[#8C8C8C] rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-white group-hover:border-white transition-all duration-200 ease-in-out">
